...
frappe.ui.form.on('Header Component', {
    ...
    delete_sections: function(frm, name, parentfield) {
	 ...
	 pick_layout(frm){
		frappe.call({
			method:"netmanthan_cms.netmanthan_cms.doctype.header_component.header_component.get_header_layouts",
			args:{},
			freeze:true,
			callback:(res) =>{
...
var add_new_section = Class.extend({
    ...
    get_section_templates: function() {
        let me = this;
        frappe.call({
            method: 'netmanthan_cms.netmanthan_cms.doctype.web_page_builder.web_page_builder.get_header_section_templates',
            args: {
                device_type: me.device_type
            },
            async: false,
