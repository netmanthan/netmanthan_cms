...
frappe.require("assets/netmanthan_cms/js/jquery.ui.min.js");
frappe.require("assets/netmanthan_cms/js/uppy.min.css");
frappe.require("assets/netmanthan_cms/js/uppy.min.js");
frappe.require("assets/netmanthan_cms/css/jodit.min.css");
frappe.require("assets/netmanthan_cms/js/jodit.min.js");
frappe.require("assets/netmanthan_cms/js/jquery.slimscroll.min.js");
...
frappe.ui.form.on('Web Page Builder', {
    ...
    refresh: function(frm) {
        ...
        if(frm.doc.document && frm.doc.w_page_type=="List"){
           frm.set_query("data_fetch_from", function() {
            return {
                "query":"netmanthan_cms.netmanthan_cms.doctype.web_page_builder.web_page_builder.get_linked_docs",
                "filters": {
           ...
           if(frm.doc.w_page_type=="List" && frm.doc.enable_side_menu==1){
               frappe.call({
                    method: 'netmanthan_cms.netmanthan_cms.doctype.web_page_builder.web_page_builder.get_side_menu_fields',
                    args: {
        ...
        if(frm.doc.document && frm.doc.w_page_type=="Detail"){
              frappe.call({
                        method: 'netmanthan_cms.netmanthan_cms.doctype.web_page_builder.web_page_builder.get_linked_fields',
                        args: {
                             "document": frm.doc.document
                        },
                        freeze: true,
        ...
        if(frm.doc.route && frm.doc.w_page_type!="List" && frm.doc.w_page_type!="Detail"){
         frappe.db.get_doc("CMS Settings","CMS Settings", {
                    ...
                    if(res.enable_netmanthan_builder){
                        
                          frm.set_df_property('edit_with_netmanthan_builder', 'hidden', 0)
                    }
                })
        }
        if (frm.doc.__islocal) {
               ...
               var title_dialog =   new frappe.ui.Dialog({
                     ...
                     title_dialog.set_primary_action(__('Save As Template'), function() {
                         let val = title_dialog.get_values();
                          frappe.call({
                                method: 'netmanthan_cms.netmanthan_cms.doctype.web_page_builder.web_page_builder.save_as_template',
                                args: {
    ...
    store_global_font_and_weight_values(frm){
        ...
        .then(r => {
            if(r && r.message && r.message.name){
                frappe.call({
                    method: 'netmanthan_cms.netmanthan_cms.doctype.web_page_builder.web_page_builder.get_global_fonts',
                    args: {
    ...
    edit_with_netmanthan_builder:function(frm){
        window.location.href="/app/netmanthancms-builder?route="+frm.doc.route;
    },
        ...
        if (frm.doc[field] && frm.doc[field].length > 0) {
            frm.doc[field].map(f => {
                ...
                let row = $(`<tr data-id="${f.name}">
                    <td style="width: 50%;"><img src="/assets/netmanthan_cms/images/section-icon.svg" style="height:30px;cursor: all-scroll;position: relative;top: 8px;margin-right: 10px;"> ${section_data}</td>
    ...
    delete_sections: function(frm, name, parentfield) {
        frappe.confirm(
            ...
            function(){
              frappe.call({
                    method: 'netmanthan_cms.netmanthan_cms.doctype.web_page_builder.web_page_builder.delete_section',
                    args: {
                        name: name,
    ...
    edit_styles_sections: function(frm, name, parentfield) {
        var id=name;
        frappe.call({
                method: 'netmanthan_cms.netmanthan_cms.doctype.web_page_builder.web_page_builder.get_section_properties',
                    ...
                    if(r.message.styles){
                        ...
                        //    console.log(">> Submitted value <<",values)
                           ...
                           for (let k in values) {
                            ...
                            $('[data-fieldname="'+id+'"]').attr("style_json",JSON.stringify(style_json))
                             frappe.call({
                                method: 'netmanthan_cms.netmanthan_cms.doctype.web_page_builder.web_page_builder.update_section_properties',
                       ...
                       if(enable_font_media_query){
                        ...
                        function poup_bg_dialog(bg_type){
                            frappe.call({
                                method:"netmanthan_cms.netmanthan_cms.doctype.web_theme.web_theme.get_color_code_data",
...
var add_new_section = Class.extend({
    ...
    get_all_sections: function() {
        let me = this;
        frappe.call({
            method: 'netmanthan_cms.netmanthan_cms.doctype.web_page_builder.web_page_builder.get_sections',
            args: {
    ...
    get_section_templates: function() {
        let me = this;
        frappe.call({
            method: 'netmanthan_cms.netmanthan_cms.doctype.web_page_builder.web_page_builder.get_section_templates',
            args: {
                device_type: me.device_type
            },
            async: false,
    ...
    make_dialog: function() {
        ...
        //             }
        //             frappe.call({
        //                 method: 'netmanthan_cms.netmanthan_cms.doctype.web_page_builder.web_page_builder.convert_template_to_section',
        //                 args: {
...
function bind_layout_data(wrapper){
    frappe.call({
        method: "netmanthan_cms.netmanthan_cms.doctype.section_template_layout.section_template_layout.get_layout_data",
        args: {},
        freeze: true,
        callback: function (r) {
...
var modify_section_data = Class.extend({
    ...
    get_data_fields: function() {
        let me = this;
         // console.log(me,"me----")
        frappe.call({
            method: 'netmanthan_cms.netmanthan_cms.doctype.web_page_builder.web_page_builder.get_section_content',
            args: {
                section: me.section,
    ...
    get_patterns: function() {
        let patterns = []
        frappe.call({
            method: 'netmanthan_cms.netmanthan_cms.doctype.web_page_builder.web_page_builder.get_patterns_list',
            args: {},
            async: false,
            callback: function(r) {
                if (r.message) {
    ...
    get_blog_category:function(type){
          ...
          if(type=='shuffle'){
              if(is_dynamic_data_val==0 && reference_name_val!=""){
                frappe.call({
                    method: 'netmanthan_cms.netmanthan_cms.doctype.web_page_builder.web_page_builder.get_shuffled_blog_category',
                    args: {
                    ...
                    callback: function(r) {
                        ...
                        if(r.message){
                               ...
                               for (var i = 0; i < r.message.length; i++) {
                                   ...
                                   row ="<tr><td><img src='/assets/netmanthan_cms/images/section-icon.svg' style='height:30px;cursor: all-scroll;position: relative;top: 0;margin-right: 10px;text-align: center;left: 10px;'></td><td style='width:200px'>"+r.message[i].name+"</td><td>"+image_html+r.message[i].title+"</td></tr>";
                                   t_html.append(row)
                               }
           ...
           for (var i = 0; i < json_data.length; i++) {
               ...
               if(json_data[i].thumbnail_image!=null && json_data[i].thumbnail_image!=undefined){
                ...
                row ="<tr><td><img src='/assets/netmanthan_cms/images/section-icon.svg' style='height:30px;cursor: all-scroll;position: relative;top: 0;margin-right: 10px;text-align: center;left: 10px;'></td><td style='width:200px'>"+json_data[i].name+"</td><td>"+image_html+json_data[i].title+"</td></tr>";
               t_html.append(row)
           }
           t_html.appendTo(p_html);
           me.dialog.$wrapper.find('[data-fieldname="blog_category_html"]').parent().parent().parent().parent().show();
    ...
    get_category_products:function(type){
          ...
          if(type=='shuffle'){
              if(is_dynamic_data_val==0 && reference_name_val!=""){
                frappe.call({
                    method: 'netmanthan_cms.netmanthan_cms.doctype.web_page_builder.web_page_builder.get_shuffled_category_products',
                    args: {
                        category: reference_name_val,
                        no_of_records:no_of_records_val
                    },
                    ...
                    callback: function(r) {
                        ...
                        if(r.message){
                               ...
                               for (var i = 0; i < r.message.length; i++) {
                                   ...
                                   row ="<tr><td><img src='/assets/netmanthan_cms/images/section-icon.svg' style='height:30px;cursor: all-scroll;position: relative;top: 0;margin-right: 10px;text-align: center;left: 10px;'></td><td style='width:200px'>"+r.message[i].name+"</td><td>"+image_html+r.message[i].item+"</td></tr>";
                                   t_html.append(row)
                               }
                               t_html.appendTo(p_html);
           ...
           for (var i = 0; i < json_data.length; i++) {
               ...
               if(json_data[i].product_image!=null && json_data[i].product_image!=undefined){
                ...
                row ="<tr><td><img src='/assets/netmanthan_cms/images/section-icon.svg' style='height:30px;cursor: all-scroll;position: relative;top: 0;margin-right: 10px;text-align: center;left: 10px;'></td><td style='width:200px'>"+json_data[i].name+"</td><td>"+image_html+json_data[i].item+"</td></tr>";
               t_html.append(row)
           }
           t_html.appendTo(p_html);
           me.dialog.$wrapper.find('[data-fieldname="category_products_html"]').parent().parent().parent().parent().show();
    ...
    get_fields_list: function() {
        ...
        if (this.fields.section_type == 'Predefined Section' && !this.fields.dynamic_data && !this.fields.is_login_required) {
            ...
            // frappe.call({
            //     method: 'netmanthan_cms.netmanthan_cms.doctype.web_page_builder.web_page_builder.get_featured_products',
            //     args: {},
            //     async: false,
            //     callback: function(r) {
            //         data = r.message
    ...
    save_data: function() {
        ...
        //     css_design +="}"
            ...
            //     frappe.call({
            //         method: 'netmanthan_cms.netmanthan_cms.doctype.web_page_builder.web_page_builder.generate_css_file',
            //         args: {
        ...
        if (results.length > 0 || me.list_section_data.length > 0) {
            console.log(results)
            frappe.call({
                method: 'netmanthan_cms.netmanthan_cms.doctype.web_page_builder.web_page_builder.update_section_content',
                args: {
                    docs: results,
    ...
    update_design: function() {
        ...
        if (this.selected_pattern) {
            ...
            frappe.call({
                method: 'netmanthan_cms.netmanthan_cms.doctype.web_page_builder.web_page_builder.update_patterns',
        ...
        if (!section_data || section_data == '')
            ...
            table.find('tbody').append(row);
                    ...
                    row.find('.btn-danger').click(function() {
                        ...
                        frappe.call({
                            method: 'netmanthan_cms.netmanthan_cms.doctype.web_page_builder.web_page_builder.update_featured_item',
                            args: {
                                doctype: me.fields.reference_document,
                                name: val.preitem,
                                checked: 1,
    ...
    get_random_records: function(dt, records) {
        let me = this;
        frappe.call({
            method: 'netmanthan_cms.netmanthan_cms.doctype.web_page_builder.web_page_builder.get_random_records',
            args: {
                dt: dt,
                records: records,
                business: cur_frm.doc.business
    ...
    get_predefined_records: function(name, dt, no_of_records, business) {
        let me = this;
        frappe.call({
            method: 'netmanthan_cms.netmanthan_cms.doctype.web_page_builder.web_page_builder.get_predefined_records',
            args: {
                dt: dt,
    ...
    get_collections_records: function(collections) {
        let me = this;
        frappe.call({
            method: 'netmanthan_cms.netmanthan_cms.doctype.web_page_builder.web_page_builder.get_collection_records',
            args: {
    ...
    get_image_album: function(dt, dn) {
        let me = this;
        frappe.call({
            method: 'netmanthan_cms.netmanthan_cms.doctype.web_page_builder.web_page_builder.get_image_album',
            args: {
                dt: dt,
                dn: dn,
                business: cur_frm.doc.business
    ...
    upload_component: function(target, progress) {
        ...
        var uppy = Uppy.Core({
            ...
            .use(Uppy.XHRUpload, {
                endpoint: window.location.origin + '/api/method/netmanthan_cms.netmanthan_cms.doctype.web_page_builder.web_page_builder.upload_img',
                method: 'post',
                formData: true,
                fieldname: 'file',
                headers: {
...
var add_page_template = Class.extend({
    ...
    get_page_templates: function() {
        let me = this;
        frappe.call({
            method: 'netmanthan_cms.netmanthan_cms.doctype.web_page_builder.web_page_builder.get_page_templates',
            args: {
            ...
            item.click(function() {
                if(cur_frm.doc.page_title!="" && cur_frm.doc.page_title!=undefined){
                    ...
                    frappe.confirm('Are you sure you want to proceed?',
                        () => {
                             frappe.call({
                                    method: 'netmanthan_cms.netmanthan_cms.doctype.web_page_builder.web_page_builder.import_sections_from_template',
                                    args: {
...
var add_list_template = Class.extend({
    ...
    get_page_templates: function() {
        let me = this;
        frappe.call({
            method: 'netmanthan_cms.netmanthan_cms.doctype.web_page_builder.web_page_builder.get_list_page_templates',
            args: {
            },
            async: false,
            callback: function(r) {
...
var columns_mapping = Class.extend({
    ...
    get_section_columns: function() {
        let me = this;
        frappe.call({
            method: 'netmanthan_cms.netmanthan_cms.doctype.web_page_builder.web_page_builder.get_section_columns',
            args: {
...
var add_detail_template = Class.extend({
    ...
    get_page_templates: function() {
        let me = this;
        frappe.call({
            method: 'netmanthan_cms.netmanthan_cms.doctype.web_page_builder.web_page_builder.get_detail_page_templates',
            args: {
            },
            async: false,
            callback: function(r) {
