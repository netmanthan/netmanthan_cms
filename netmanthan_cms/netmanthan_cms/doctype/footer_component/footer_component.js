...
frappe.ui.form.on('Footer Component', {
    ...
    pick_layout(frm){
		frappe.call({
			method:"netmanthan_cms.netmanthan_cms.doctype.footer_component.footer_component.get_footer_layouts",
			args:{},
			freeze:true,
			callback:(res) =>{
...
var add_new_section = Class.extend({
    ...
    get_section_templates: function() {
        let me = this;
        frappe.call({
            method: 'netmanthan_cms.netmanthan_cms.doctype.web_page_builder.web_page_builder.get_footer_section_templates',
            args: {
                device_type: me.device_type
            },
            async: false,
