...
frappe.ui.form.on('Section Content', {
    ...
    setup_defaults:function(frm,cdt,cdn){
      frappe.call({
                method: 'netmanthan_cms.netmanthan_cms.doctype.web_page_builder.web_page_builder.get_section_element_properties',
                args: {"id":cdn},
                async: false,
                callback: function(r) {
...
cms.SectionBuilder = Class.extend({
    ...
    get_layouts: function () {
        let me = this;
        frappe.call({
            method: 'netmanthan_cms.netmanthan_cms.api.get_section_layouts',
            args: {},
            callback: function (r) {
                if (r.message) {
    ...
    get_components: function () {
        let me = this;
        frappe.call({
            method: 'netmanthan_cms.netmanthan_cms.api.get_section_components',
            args: {},
            callback: function (r) {
                if (r.message) {
    ...
    get_css_properties: function () {
        let me = this;
        frappe.call({
            method: 'netmanthan_cms.netmanthan_cms.api.get_styles_list',
            args: {},
            callback: function (r) {
                if (r.message) {
