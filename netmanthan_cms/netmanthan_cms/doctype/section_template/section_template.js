...
frappe.ui.form.on('Section Template', {
	...
	choose_style_properties:function(frm){
		frappe.call({
			method:"netmanthan_cms.netmanthan_cms.doctype.section_template.section_template.get_css_fields",
			args:{},
			callback:function(r){
	...
	get_linked_documents: function (frm) {
		frappe.call({
			method: 'netmanthan_cms.netmanthan_cms.doctype.section_template.section_template.get_linked_documents',
			args: {
...
{% include 'netmanthan_cms/netmanthan_cms/doctype/section_template/section_content.js' %}
...
var print_builder = Class.extend({
    ...
    async get_sections() {
		...
		await frappe.call({
			method: '',
			type: "post",
			url: "/api/method/netmanthan_cms.netmanthan_cms.doctype.web_page_builder.web_page_builder.get_section_templates",
			args: {
				device_type: "Web",
			},
			freeze: true,
