...
$.getScript('https://cdn.jsdelivr.net/npm/@editorjs/editorjs@latest', function () {
// const Undo = frappe.require('editorjs-undo');
const Undo = ""
...
var wrapper = cur_frm.fields_dict["custom_html_section_view"].$wrapper;
console.log(wrapper)
cur_frm.SectionPage = new sec_items(wrapper);
// cur_frm.SectionPage = new secPage(wrapper);
console.log(cur_frm.SectionPage)
$(wrapper).bind('div[data-fieldname="custom_html_section_view"]', function () {
	cur_frm.SectionPage.show();
});
// cur_frm.set_df_property(c.tab_html_field,"options",drp_html);
